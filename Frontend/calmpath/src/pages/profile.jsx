...
export default function Profile() {
  ...
  // last booking → upcoming
  const upcoming =
    total > 0 ? userBookings[total - 1] : null;

  // before last → previous therapists
  ...
  return (
    <Layout>
      <div style={page}>
        ...
        {/* UPCOMING SESSION */}
        <section style={card}>
          <h3 style={sectionTitle}>⏳ Upcoming Session</h3>
        ...
        <div style={quote}>
          🌿 <i>
            ...
            You’re moving forward — and that matters.
          </i>
        </div>
      </div>
    </Layout>
